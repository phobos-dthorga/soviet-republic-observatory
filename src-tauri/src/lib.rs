...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_environment_telemetry_capability,
            commands::capture_environment_validation_snapshot,
            commands::record_environment_validation_comparison,
            commands::list_environment_validation_comparisons,
