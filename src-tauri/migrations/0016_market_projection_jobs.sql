ALTER TABLE warehouse_projection_jobs RENAME TO warehouse_projection_jobs_v15;
...
CREATE TABLE warehouse_projection_jobs (
    ...
    projection_kind TEXT NOT NULL CHECK (
        projection_kind IN (
            'observation', 'market_observation', 'overlay_state',
...
SELECT projection_id, projection_kind, source_identity, status, requested_at_ms,
       started_at_ms, applied_at_ms, attempt_count, error_code
FROM warehouse_projection_jobs_v15;

DROP TABLE warehouse_projection_jobs_v15;
