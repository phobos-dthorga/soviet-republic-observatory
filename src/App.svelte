<script lang="ts">
  import ObservatoryChart from "./lib/charts/ObservatoryChart.svelte";
  import {
    attentionPreview,
  ...
  <header class="command-bar">
    ...
    <nav aria-label="Primary workspaces">
      {#each workspaces as workspace}
        <button
          class:active={workspace === "Briefing"}
          disabled={workspace !== "Briefing"}
        >
          {workspace}
        </button>
      {/each}
  ...
  <section class="workspace">
    <aside class="navigator" aria-label="Briefing navigation">
      ...
      <div class="sidebar-note">
        ...
        <p>
          This interface uses synthetic values. Connected observations will
          retain source, coverage, parser version, and actual game date.
        </p>
      </div>
    </aside>
    ...
    <section class="canvas" id="briefing">
      ...
      <header class="page-heading">
        ...
        <div class="date-stamp">
          <span>Plan year</span><strong>04 / 05</strong><small
            >74% elapsed</small
          >
        </div>
      </header>
      ...
      <section class="material-panel" id="materials">
        <header class="panel-heading">
          <div>
            ...
            <p>
              Each cell is a resource index and a route into its complete
              evidence dossier.
            </p>
          </div>
